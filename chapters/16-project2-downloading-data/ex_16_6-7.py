...
# Start with the file 'eq_world_map.py'

# Exercise 16-6 - Refactoring
# Extract the data and append it to the appropriate list in one line vs. two

# Exercise 16-7 - Automated Title
# Instead of hard coding the chart title, extract it from the JSON metadata
