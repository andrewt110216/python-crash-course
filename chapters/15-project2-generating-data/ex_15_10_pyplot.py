...
data = go.Scatter(x=rw.x_values, y=rw.y_values, mode='markers+text',
                  marker=marker, fillcolor='white')
xaxis = {'visible': False}
yaxis = {'visible': False}
layout = go.Layout(xaxis=xaxis, yaxis=yaxis, paper_bgcolor='dimgray',
                   plot_bgcolor='wheat')
